...
<article class="obj_article_details">
	...
	{if isset($pubLocaleData.opts.title)}
		<span aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.titles"}" role="group" data-pkp-switcher="titles">
						...
						<li>
							<div>
								...
								<span
									...
									lang="{$pubLocaleData.langAttrs[$pubLocaleData["author{$author@index}Name"].defaultLocale]}"
								>
								...
								{if isset($pubLocaleData.opts.author)}
									<span aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.author"}" role="group" data-pkp-switcher="author{$author@index}">
										<ul role="listbox" aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.select"}"></ul>
									</span>
								{/if}
							</div>
							{if $author->getAffiliations()}
								...
								<span class="affiliation">
									<span
										...
										lang="{$pubLocaleData.langAttrs[$pubLocaleData["author{$author@index}Affiliation"].defaultLocale]}"
									>
				...
				<section class="item keywords">
					...
					<span>
						...
						{if isset($pubLocaleData.opts.keywords)}
							<span aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.keywords"}" role="group" data-pkp-switcher="keywords">
								<ul role="listbox" aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.select"}"></ul>
							</span>
						{/if}
					</span>
				...
				<section class="item abstract">
					<div>
						...
						{if isset($pubLocaleData.opts.abstract)}
							<span aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.abstract"}" role="group" data-pkp-switcher="abstract">
								<ul role="listbox" aria-label="{translate key="plugins.themes.default.languageSwitcher.ariaDescription.select"}"></ul>
							</span>
						{/if}
					</div>
